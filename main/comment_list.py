...
def commentList(video_id):
    ...
    while response:
        for item in response['items']:
            ...
            comment_list.append({"profile_img": comment["authorProfileImageUrl"], "profile_name": comment['authorDisplayName'], "comment": comment['textOriginal'], "comment_idx": 0, "datetime": comment['publishedAt']})
